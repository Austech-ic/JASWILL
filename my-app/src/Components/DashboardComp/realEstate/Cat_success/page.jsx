...
console.log(property)
  ...
  <td className=''>
    <div className=' md:flex h-[1rem] md:h-[3rem] w-[3rem] md:w-[10rem] text-center'>
      ...
      <Image src={item.image} width={100} height={100} alt='pic' className='w-full h-full object-contain md:object-none' />
    </div>
  </td>
  ...
  <p className='text-xs md:text-lg lg:text-sm'>{truncateTitle(item.description, 5)}</p>
</td>
<td className='text-center text-xs md:text-sm'>
