          ...
          <div key={datum.id} className='p-5 w-full'>
            <div className='relative'>
              <div className='h-48 w-full'>
                <Image src={datum.imageUrl} width={100} height={100} alt='fade-img' style={{ width: '100%', height: '100%' }} className='h-full w-full object-cover' />
              </div>
            ...
            <div className=' py-3 px-2 flex flex-col justify-between items-start '>
              ...
              <div className='h-8 md:h-10 w-full lg:h-[65px]  cursor-pointer font-bold '>
                <p className='text-base md:text-xl lg:text-lg xl:text-xl'>{datum.title}</p>
              </div>
